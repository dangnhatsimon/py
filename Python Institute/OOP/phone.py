...
mob_phone_1 = phone(number = '0354883673')
mob_phone_2 = phone(number = '079095029864')

print(mob_phone_1.turn_on())
print(mob_phone_2.turn_on())
print(mob_phone_1.call('123456789'))
print(mob_phone_1.turn_off())
print(mob_phone_2.turn_off())
